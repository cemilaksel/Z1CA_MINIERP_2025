...
*& Methods are prefixed with MVC pattern for better understanding:
...
*&---------------------------------------------------------------------*
CLASS z1ca_cl_table_create DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS Z1CA_CL_TABLE_CREATE IMPLEMENTATION.
